...
// Notes to Grader: I used an array of objects, and casted each element into a Linked List every
// time I modified them. Seemed to work pretty well!
 ...
 *                    pair.
 */
public class HashTableMap_Drew<KeyType, ValueType> {
   ...
   */
  public HashTableMap_Drew(int capacity) {
